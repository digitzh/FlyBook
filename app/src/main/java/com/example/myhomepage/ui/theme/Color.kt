...
val clear = Color(0x0FFFFFFF).convert(ColorSpaces.CieXyz)
val white = Color(0xFF0980FB).convert(ColorSpaces.CieXyz)
val white1 = Color(0xFFF7F7F7).convert(ColorSpaces.CieXyz)
val white2 = Color(0xFFEDEDED).convert(ColorSpaces.CieXyz)
val white3 = Color(0xFFFFFFFF).convert(ColorSpaces.CieXyz)
...
val myblue = Color(0xFF0980FB).convert(ColorSpaces.CieXyz)